...
//图层stack
  Widget layerListWidget() {
    ...
    for (var item in customerLayers) {
      tiles.add(
        Positioned(
          ...
          top: item.layerPosition.top + Provider.of<RenderBoxProvider>(context, listen: false).screenFromEditTop - Utils.setWidth(42), 
    ...
    content = new Container(
      color: Colors.transparent,//Color(0x55ffffff),
      child: Stack(overflow: Overflow.visible, children: tiles),
    );
    return content;
  }
    ...
    return GestureDetector(
            ...
            onScaleUpdate: (ScaleUpdateDetails e) {
              ...
              if(e.scale != 1){
                ...
                // }else{
                //   if(preHscale <= 1){
                //     hScale = hScale + (hScale * 0.17);
                //   }else{
                //     hScale = 1;
                //   }
                // }
                // if(e.verticalScale > 1){
                //   if(preVscale >= 1){
                //     vScale = vScale * 0.83;
                //   }else{
                //     vScale = 1;
                ...
                // }else{
                //   if(preVscale <= 1){
                //     vScale = vScale + (vScale * 0.17);
                //   }else{
                //     vScale = 1;
                //   }
                // }
                // print('水平比例${hScale}-----垂直比例${vScale}');
                w =  _preWidth * hScale;
                h = _preHeight * vScale;
                if(w < 100){
                  w = 100;
          ...
          Row(children: <Widget>[
            ...
            Container(
              ...
              child: 
                ...
                //全屏按钮
                Offstage(
                  offstage: item.layerPosition.width - borderWidth < Utils.setWidth(78)? true : false,
                  child: GestureDetector(
                    child: Container(
                      color: Colors.transparent,
                      width: Utils.setWidth(32), 
                      alignment: Alignment.center,
                      // margin: item.layerPosition.width - borderWidth > Utils.setWidth(74)?EdgeInsets.only(right: Utils.setHeight(10)):EdgeInsets.only(right: 0),
                ...
                //删除按钮
                Offstage(
                  offstage: item.layerPosition.width - borderWidth > Utils.setWidth(44)? false : true,
                  child: GestureDetector(
                    child: Container(
                      color: Colors.transparent,
                      width: Utils.setWidth(32), 
                      margin: EdgeInsets.only(left: Utils.setWidth(10)),
                      alignment: Alignment.center,
