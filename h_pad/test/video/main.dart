...
import 'smartolayer.dart';
import 'smartplayer_plugin.dart';
...
class _MyAppState extends State<MyApp> {
          ...
          body: new SingleChildScrollView(
            child: new Column(
              children: <Widget>[
                ...
                new Row(
                  children: [
                    new RaisedButton(onPressed: this.onSmartPlayerStartPlay, child: new Text("开始播放")),
                    new Container(width: 20),
                    new RaisedButton(onPressed: this.onSmartPlayerStopPlay, child: new Text("停止播放")),
                    new Container(width: 20),
                    new RaisedButton(onPressed: this.onSmartPlayerMute, child: new Text("实时静音")),
                  ],
                ),
                new Row(
                  children: [
                    new RaisedButton(onPressed: this.onSmartPlayerSwitchUrl, child: new Text("实时切换URL")),
                    new Container(width: 20),
                    new RaisedButton(onPressed: this.onSmartPlayerSetRotation, child: new Text("实时旋转View")),
                  ],
                ),
                new TextField(
  ...
  Future<void> onSmartPlayerStartPlay() async {
    ...
    if (playback_url_controller_.text.length < 8) {
      playback_url_controller_.text = "rtmp://live.hkstv.hk.lxdns.com/live/hks1"; //给个初始url
    }
