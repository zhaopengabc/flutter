 ...
 * @Date: 2020-05-25 14:49:26
 * @LastEditors: haojieyu
 * @LastEditTime: 2020-05-25 14:49:35
 */ 
/*
 * @Description: Do not edit
 * @Author: benmo
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RaisedButton(
                child: Text('连接'),
                color: _isConnectDisabled ? Theme.of(context).primaryColor : ColorMap.button_disabled_color,
                textColor: Colors.white,
                padding: EdgeInsets.only(left: Utils.setWidth(6)),
                onPressed: () {
                  if (!_isConnectDisabled) {
                    return;
                  }
                  setState(() {
